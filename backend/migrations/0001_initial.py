# Generated by Django 4.2.5 on 2024-01-27 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network', models.CharField(choices=[('STAFF', 'Staff'), ('SECU', 'Security')], default='STAFF', help_text='Network the phone is on', max_length=8)),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
